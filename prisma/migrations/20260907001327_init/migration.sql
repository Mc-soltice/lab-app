...
CREATE TABLE `emissions` (
    ...
    UNIQUE INDEX `emissions_slug_key`(`slug`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `podcasts` (
    ...
    `media_type` VARCHAR(191) NOT NULL DEFAULT 'AUDIO',
    `cover_image` VARCHAR(191) NULL,
...
CREATE TABLE `books` (
    ...
    INDEX `books_status_published_at_idx`(`status`, `published_at`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `bookmarks` (
    ...
    INDEX `bookmarks_podcast_id_idx`(`podcast_id`),
    INDEX `bookmarks_book_id_idx`(`book_id`),
...
-- AddForeignKey
ALTER TABLE `podcasts` ADD CONSTRAINT `podcasts_emission_id_fkey` FOREIGN KEY (`emission_id`) REFERENCES `emissions`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
